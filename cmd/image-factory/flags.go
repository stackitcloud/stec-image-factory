...
func initFlags() cmd.Options {
	...
	flag.StringVar(&opts.OverrideSourceImageRegistry, "override-source-image-registry", cmd.DefaultOptions.OverrideSourceImageRegistry, "override the source image registry defined in extension/overlay images with the one defined here (optional)")
