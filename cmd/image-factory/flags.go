...
func initFlags() cmd.Options {
	...
	flag.StringVar(&opts.OverrideSourceImageRegistry, "override-source-image-registry", cmd.DefaultOptions.OverrideSourceImageRegistry, "override the source image registry defined in extension/overlay images with the one defined here (optional)") //nolint:lll
	...
	flag.BoolVar(&opts.ContainerSignatureDisabled, "container-signature-disabled", cmd.DefaultOptions.ContainerSignatureDisabled, "disable container signature verification (not recommended)")
